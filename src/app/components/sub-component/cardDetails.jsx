      ...
      <div className="space-y-6 text-white p-6 max-h-[80vh] overflow-y-auto"> 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="col-span-1">
            ...
            <CardContent className="text-gray-300 flex flex-col">
        ...
        <Card className="col-span-2">
          ...
          <CardContent>
            <ScrollArea className="h-[200px] w-full border p-4 text-gray-300">
        ...
        <Card className="col-span-2">
          ...
          <CardContent>
            <ScrollArea className="h-[200px] border w-full p-4 text-gray-300">
              {speechRequirements}
            </ScrollArea>
          </CardContent>
        </Card>
